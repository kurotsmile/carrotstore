...
if(isset($_POST['function'])&&$_POST['function']=='update_info_user'){
    ...
    $query_update_user=mysql_query("UPDATE `app_my_girl_user_".$user_lang."` SET `name` = '$user_name',`sex` = '$user_sex',`address` = '$user_address',`sdt` = '$user_sdt',`status` = '$user_status',`email` = '$user_email' WHERE `id_device` = '$user_id' LIMIT 1;");
