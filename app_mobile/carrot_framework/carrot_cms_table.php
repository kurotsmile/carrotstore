...
<div class="cms_nav_page"> 
    ...
    <?php for($i=1;$i<=$total_page;$i++){?>
        <?php if($i==$current_page){?>
            <a href="<?php echo $url_cur;?>&p=<?php echo $i;?>" class="btn gray"><?php echo $i;?></a>
        <?php }else{?>
            <a href="<?php echo $url_cur;?>&p=<?php echo $i;?>" class="btn"><?php echo $i;?></a>
        <?php }?>
    <?php } ?>
</div>
<?php }?>
...
<?php
    ...
    <tr>
        ...
        ?>
            <td>
                <a href="<?php echo $this->btn_function('edit_obj',$name_table,$row_table[$tabel_head[0]],$tabel_head[0]);?>" class="buttonPro small yellow"><i class="fa fa-pencil-square" aria-hidden="true"></i> Sửa</a>
                <a href="<?php echo $this->btn_function('delete_obj',$name_table,$row_table[$tabel_head[0]],$tabel_head[0]);?>" class="buttonPro small red"><i class="fa fa-trash" aria-hidden="true"></i> Xóa</a>
            </td>
    </tr>
    <?php
    }
