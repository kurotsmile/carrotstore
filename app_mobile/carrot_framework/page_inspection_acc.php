...
?>
<div class="app_ins">
    <div class="title"><i class="fa fa-universal-access" aria-hidden="true"></i> Tài khoản sai phạm (<span id="count_acc"><?php echo $num_acc;?></span>)</div>
    <div class="body">
        <table>
        <?php 
        ...
        ?>
            <tr class="acc_<?php echo $id_device;?> acc_emp" style="display:block;width:100%">
                ...
                <td>
                    <?php echo $this->user($id_device,$lang_acc);?>
                ...
                <td>
                    ...
                    <?php if($txt_report!=''&&$lang_acc!='vi'){?>
                        <a onclick="$(this).addClass('blue');" target="_blank" href="https://translate.google.com/?sl=<?php echo $lang_acc;?>&tl=vi&text=<?php echo $txt_report;?>&op=translate" class="buttonPro small"><i class="fa fa-language" aria-hidden="true"></i></a>
                    <?php }?>
                </td>
            </tr>
        <?php
