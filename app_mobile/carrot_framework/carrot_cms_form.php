...
class carrot_form{
    ...
    public function paser_table_mysql($table_mysql,$data_default=null,$database=''){
        global $link;
        if($database!="")
            $query_field=mysqli_query($link,"SELECT `COLUMN_NAME` as 'name',`DATA_TYPE` as 'type'  FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME='$table_mysql' AND `TABLE_SCHEMA`='".$database."'");
        else
            $query_field=mysqli_query($link,"SELECT `COLUMN_NAME` as 'name',`DATA_TYPE` as 'type'  FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME='$table_mysql' AND `TABLE_SCHEMA`='".$this->carrot_cms->database_mysql."'");
    ...
    public function handle_post(){
        ...
        if(isset($data["frm_fnc_update"])){
            ...
            $sql_command="UPDATE `".$this->table_mysql."` SET ".$sql_field." ".$sql_where;
            echo $sql_command."<hr/>";
        ...
        if(isset($data["frm_fnc_add"])){
            ...
            $sql_command="INSERT INTO `".$this->table_mysql."` $sql_field VALUES $sql_val";
            $sql_query=mysqli_query($link,$sql_command);
    ...
    public function show(){
        ...
        $html.="<form class='carrot_form' method='post' id='".$this->id."'>";
        $html.="<fieldset>";
