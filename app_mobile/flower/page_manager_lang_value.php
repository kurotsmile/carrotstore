...
<tr>
    ...
    <td>
        <a href="<?php echo $url;?>?view=manager_lang_key&edit_id=<?php echo $row_key['id']; ?>&name_key=<?php echo $row_key['name_key']; ?>" class="buttonPro small"><i class="fa fa-edit"></i> sửa tag</a>
        <?php 
        if($lang_key_to!=''){
