...
<a href="<?php echo $url_cur;?>&tool=table_create" class="buttonPro small <?php if($tool=='table_create') echo 'blue'; ?>"><i class="fa fa-table" aria-hidden="true"></i> Tạo bảng lưu trữ web (Mysql)</a>
