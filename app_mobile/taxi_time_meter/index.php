...
$cms=new Carrot_CMS("Taxi",$link,dirname(__FILE__));
$cms->url_carrot_store=$url_carrot_store;
$cms->url=$url_carrot_store."/app_mobile/taxi_time_meter";
...
$cms->add_menu_page("Đơn vị tiền tệ","fa-usd","page_currency_unit.php");
