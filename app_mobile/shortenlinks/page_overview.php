...
while($country=mysqli_fetch_array($query_list_country)){
    ...
    $query_count_log=mysqli_query($link,"SELECT * FROM `log` WHERE `lang` = '$key_country'");
    ...
    <div class="box <?php if($is_sel=='on'){?>active<?php }?>">
        ...
        <div class="body">
            <ul>
                <li>Đã có <b><?php echo mysqli_num_rows($query_count_log);?></b> liên kết rút gọn được tạo ở quốc gian này</li>
                <li>
                    <?php if($is_sel=='on'){?>
