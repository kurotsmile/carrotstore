          ...
          <div class="card mb-4 shadow-sm">
            ...
            <div class="card-body">
              ...
              <div class="d-flex justify-content-between align-items-center">
                <div class="btn-group">
                  <a href="<?php echo $url_music;?>" type="button" class="btn btn-sm btn-outline-secondary btn_play">
                  ...
                  <?php if($is_user_login!=''){?><a href="<?php echo $url.'/file/'.$audio['name_file'];?>" class="btn btn-sm btn-outline-secondary">Edit</a><?php }?>
                </div>
