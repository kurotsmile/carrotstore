...
?>
            <div id="row<?php echo $row['id']; ?>" class="app" oncontextmenu="show_menu_app(this,1);return false;">
                ...
                <a href="<?php echo $link_app;?>" class="app_link_icon"><img alt="<?php echo $p_name_product; ?>" title="<?php echo $label_click_de_xem.' ('.$p_name_product.')';?>" class="lazyload app_icon" data-src="<?php echo get_url_icon_product($row['id'],'100x100'); ?>" class="app_icon" width="100" height="100" /></a>
                <div class="app_txt">
                    <div class="desc">
