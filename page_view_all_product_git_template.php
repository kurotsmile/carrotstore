            ...
            <div id="row<?php echo $row['id']; ?>" class="app" oncontextmenu="show_menu_app(this,1);return false;">
                ...
                <div class="app_txt">
                    ...
                    <?php echo limit_words(get_desc_product_lang($link,$row['id'],$_SESSION['lang']),20); ?>
                        ...
                        ?>
                            <a title="<?php echo lang($link,'download_on').' (Carrot Store)';?>" alt="<?php echo lang($link,'download_on').' (Carrot Store)';?>" class="buttonPro small green" href="itms-services://?action=download-manifest&amp;url=<?php echo 'https://'.$name_host;?>/product_data/<?php echo $row['id'];?>/ios/manifest.plist" target="_blank"><i class="fa fa-apple" aria-hidden="true"></i> Ipa</a>
                        <?php }?>
                </div>
                <div class="app_type">
                ...
                <button onclick="show_menu_app(this,0);return false;" class="buttonPro small btn_more"><i class="fa fa-ellipsis-h"></i></button>
                    ...
                    <div class="menu_more">
                        ...
                        <?php
                            if(file_exists('product_data/'.$row['id'].'/ios/manifest.plist')){
                        ?>
                            <a title="<?php echo lang($link,'download_on').' (Carrot Store)';?>"  class="buttonPro orange small" href="itms-services://?action=download-manifest&amp;url=<?php echo 'https://'.$name_host;?>/product_data/<?php echo $row['id'];?>/ios/manifest.plist" target="_blank"><i class="fa fa-apple" aria-hidden="true"></i> (Ipa) <?php echo lang($link,'download_on').' (Carrot Store)';?></a>
                        <?php }?>
