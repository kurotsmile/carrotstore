<div id="row<?php echo $row['id_device']; ?>" class="app" oncontextmenu="show_menu_app(this,1);return false;">
    ...
    <a href="<?php echo $url; ?>/user/<?php echo $row['id_device']; ?>/<?php echo $lang;?>"  class="app_link_icon">
        <?php
            $url_img='app_mygirl/app_my_girl_'.$lang.'_user/'.$row['id_device'].'.png';
    ...
    <div class="app_txt">
            ...
            <p class="app_address" style="padding: 0px;margin:0px;">
                ...
                <img style="height: 12px;" src="<?php echo $url;?>/app_mygirl/img/<?php echo $lang;?>.png"/> <?php echo $lang;?>
            </p>
        <br />
    </div>
    ...
    <div class="app_action">
        <a href="<?php echo $url; ?>/user/<?php echo $row['id_device']; ?>/<?php echo $lang;?>" class="buttonPro small "><i class="fa fa-address-card-o" aria-hidden="true"></i> <?php echo $label_chi_tiet; ?></a>
    ...
    <div class="menu_more">
        ...
        <a class="buttonPro orange" href="<?php echo  $url;?>/download_vcf.php?id_user=<?php echo $row['id_device']; ?>&lang=<?php echo $lang;?>" ><i class="fa fa-download" aria-hidden="true"></i> <?php echo $label_download_vcf; ?></a>
    ...
    <script>
        arr_id_obj.push('<?php echo $row['id_device']; ?>');
    </script>
</div>