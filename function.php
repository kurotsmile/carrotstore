...
function get_url_account_google($user_id,$lang){
    ...
    $data_url=mysql_fetch_array($return);
...
function box_ads($id_product,$lang){
    ...
    $html_txt.='<a href="'.URL.'/product/'.$id_product.'"><img alt="'.get_name_product_lang($id_product,$lang).'"  style="width: 30%;float: left;margin-right: 3px;margin-top: 6px;margin-left: 6px;" class="lazyload" data-src="'.get_url_icon_product($id_product,'100').'" /></a>';
    ...
    $html_txt.='<div style="float: left;width: 60%;text-align: center;">';
        ...
        if($product_ads['chplay_store']!=''){ 
            $txt_download='<a href="'.$product_ads['chplay_store'].'"  target="_blank"><img alt="Download '.get_name_product_lang($id_product,$lang).'" style="width: 85px;float: left;margin-right: 3px;margin-top: 3px;" class="lazyload" data-src="'.URL.'/images/chplay_download.png" /></a>';
            array_push($arr_download,$txt_download);
        }
        
        if($product_ads['app_store']!=''){ 
            $txt_download='<a href="'.$product_ads['app_store'].'"  target="_blank"><img alt="Download '.get_name_product_lang($id_product,$lang).'" style="width: 85px;float: left;margin-right: 3px;margin-top: 3px;" class="lazyload" data-src="'.URL.'/images/app_store_download.png" /></a>';
            array_push($arr_download,$txt_download);
        }
        
        if($product_ads['galaxy_store']!=''){ 
            $txt_download='<a href="'.$product_ads['galaxy_store'].'"  target="_blank"><img alt="Download '.get_name_product_lang($id_product,$lang).'" style="width: 85px;float: left;margin-right: 3px;margin-top: 3px;" class="lazyload" data-src="'.URL.'/images/galaxy_store_download.png" /></a>';
            array_push($arr_download,$txt_download);
        }
        
        if($product_ads['window_store']!=''){ 
            $txt_download='<a href="'.$product_ads['window_store'].'"  target="_blank"><img alt="Download '.get_name_product_lang($id_product,$lang).'" style="width: 85px;float: left;margin-right: 3px;margin-top: 3px;" class="lazyload" data-src="'.URL.'/images/window_store_download.png" /></a>';
            array_push($arr_download,$txt_download);
        }
        
        if($product_ads['apk']!=''){ 
            $txt_download='<a href="'.$product_ads['apk'].'"  target="_blank"><img alt="Download '.get_name_product_lang($id_product,$lang).'" style="width: 85px;float: left;margin-right: 3px;margin-top: 3px;" class="lazyload" data-src="'.URL.'/images/apk_download.png" /></a>';
            array_push($arr_download,$txt_download);
        }
...
function show_ads_box_main($id_place_ads){
    ...
    $txt_html.='<div id="body_ads">';
        $txt_html.='<a href="'.URL.'/product/'.$id_product_ads.'"><img alt="Download '.get_name_product_lang($id_product_ads,$_SESSION["lang"]).'" style="width: 104px;float: left;margin-right: 3px;margin-top: 6px;margin-left: 6px;"  class="lazyload" data-src="'.get_url_icon_product($id_product_ads,'104x104').'" /></a>';
        
        $arr_download=array();
        if($data_product_ads['chplay_store']!=''){ 
            $txt_download='<a  href="'.$data_product_ads['chplay_store'].'"  target="_blank"><img alt="Download '.get_name_product_lang($id_product_ads,$_SESSION["lang"]).'" style="width: 85px;float: left;margin-right: 3px;margin-top: 3px;"  class="lazyload" data-src="'.URL.'/thumb.php?src='.URL.'/images/chplay_download.png&size=85x28&trim=1" /></a>';
            array_push($arr_download,$txt_download);
        }
        
        if($data_product_ads['app_store']!=''){ 
            $txt_download='<a href="'.$data_product_ads['app_store'].'"  target="_blank"><img alt="Download '.get_name_product_lang($id_product_ads,$_SESSION["lang"]).'" style="width: 85px;float: left;margin-right: 3px;margin-top: 3px;"  class="lazyload" data-src="'.URL.'/thumb.php?src='.URL.'/images/app_store_download.png&size=85x28&trim=1" /></a>';
            array_push($arr_download,$txt_download);
        }
        
        if($data_product_ads['galaxy_store']!=''){ 
            $txt_download='<a href="'.$data_product_ads['galaxy_store'].'"  target="_blank"><img alt="Download '.get_name_product_lang($id_product_ads,$_SESSION["lang"]).'" style="width: 85px;float: left;margin-right: 3px;margin-top: 3px;"  class="lazyload" data-src="'.URL.'/thumb.php?src='.URL.'/images/galaxy_store_download.png&size=85x28&trim=1" /></a>';
            array_push($arr_download,$txt_download);
        }
        
        if($data_product_ads['window_store']!=''){ 
            $txt_download='<a href="'.$data_product_ads['window_store'].'"  target="_blank"><img alt="Download '.get_name_product_lang($id_product_ads,$_SESSION["lang"]).'" style="width: 85px;float: left;margin-right: 3px;margin-top: 3px;"  class="lazyload" data-src="'.URL.'/thumb.php?src='.URL.'/images/window_store_download.png&size=85x28&trim=1" /></a>';
            array_push($arr_download,$txt_download);
        }
        
        if($data_product_ads['apk']!=''){ 
            $txt_download='<a href="'.$data_product_ads['apk'].'" target="_blank"><img alt="Download '.get_name_product_lang($id_product_ads,$_SESSION["lang"]).'" style="width: 85px;float: left;margin-right: 3px;margin-top: 3px;"  class="lazyload" data-src="'.URL.'/thumb.php?src='.URL.'/images/apk_download.png&size=85x28&trim=1" /></a>';
            array_push($arr_download,$txt_download);
        }
