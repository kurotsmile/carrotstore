...
if(isset($_POST['func'])&&$_POST['func']=="update"){
    ...
    $full_name=json_encode($fullname,JSON_HEX_TAG | JSON_HEX_APOS | JSON_HEX_QUOT | JSON_HEX_AMP | JSON_UNESCAPED_UNICODE);
    ...
    $address=json_encode($address,JSON_HEX_TAG | JSON_HEX_APOS | JSON_HEX_QUOT | JSON_HEX_AMP | JSON_UNESCAPED_UNICODE);
    ...
    if(isset($_POST['email'])){
        $email=$_POST['email'];
        $email=json_encode($email,JSON_HEX_TAG | JSON_HEX_APOS | JSON_HEX_QUOT | JSON_HEX_AMP | JSON_UNESCAPED_UNICODE);
