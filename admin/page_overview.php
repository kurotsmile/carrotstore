...
<div id="bar_menu_sub">
	...
	<a href="<?php echo $url_page;?>&sub_view=file" <?php if($sub_view=='file'){?>class="active"<?php }?>><i class="fa fa-file" aria-hidden="true"></i> <span class="syn product_rate" syn="product_rate"></span>Đồng bộ tệp</a>
</div>
