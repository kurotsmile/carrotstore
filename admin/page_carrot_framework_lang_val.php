...
$lang='vi';
$lang_to='';
$url_cur=$url_admin.'?page_view=page_carrot_framework&sub_view=lang_val';
...
if(isset($_POST['cr_val'])){
    ...
    if($data_cr==null){
        ...
        echo alert("Thêm mới dữ liệu thành công!");
    }else{
...
?>
    <tr>
        ...
        if($lang_to!=''){
            $link_lang='';
            if($lang_to=='zh'){
                $link_lang="https://translate.google.com/?sl=$lang&tl=".$lang_to."-CN&text=".urldecode($val_cr);
            }else{
