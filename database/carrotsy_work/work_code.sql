...
(5,	'q_data(Chuỗi truy vấn mysql)',	0,	'Truy vấn nhanh cơ sỡ dữ liệu và trả về mảng dữ liệu , hàm này giúp rút gọn quá trình viết mã của lệnh mysqli_fetch_assoc',	0),
