...
(137,	'bat_chuyen',	'Это был один из тех мартовских дней, когда солнце светит жарко, а ветер дует холодно:\r\nкогда на свете лето, а зимой в тени',	1,	2,	'#ADFFCC',	'',	'',	'',	'',	'',	0,	0,	2,	0,	'',	0,	0,	0,	'',	1,	0,	3,	'48',	'',	'4',	'2',	'0',	'0',	'0',	''),
(138,	'bat_chuyen',	'Это был один из тех мартовских дней, когда солнце светит жарко, а ветер дует холодно:\r\nкогда на свете лето, а зимой в тени',	0,	2,	'#29E644',	'',	'',	'',	'',	'',	0,	7,	2,	0,	'',	1,	0,	0,	'',	1,	0,	3,	'85',	'',	'4',	'2',	'0',	'0',	'0',	''),
(139,	'dam',	'Март, когда дни становятся длиннее, Пусть твои растущие часы будут сильными, чтобы исправить некоторые зимние ошибки.',	1,	1,	'#B0D7FF',	'',	'',	'',	'',	'',	0,	0,	7,	0,	'',	0,	0,	0,	'',	1,	0,	3,	'271',	'',	'4',	'2',	'0',	'0',	'0',	''),
(140,	'dam',	'Март, когда дни становятся длиннее, Пусть твои растущие часы будут сильными, чтобы исправить некоторые зимние ошибки.',	0,	1,	'#B0D7FF',	'',	'',	'',	'',	'',	0,	0,	7,	0,	'',	1,	0,	0,	'',	1,	0,	3,	'271',	'',	'4',	'2',	'0',	'0',	'0',	''),
