...
('ebook_muc_luc',	'Table des matières'),
('ebook_display_options',	'Options d\'affichage du livre'),
('ebook_download',	'Télécharger des livres (EBook.epub)'),
('ebook_font_size',	'Taille de police'),
('ebook_font_style',	'Le style de police'),
