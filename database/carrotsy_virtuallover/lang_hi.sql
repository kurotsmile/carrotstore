...
('search_setting',	'खोज सेंटिंग'),
('search_setting_type',	'फ़ंक्शन विकल्प खोजें'),
('search_setting_data',	'डेटा स्रोत विकल्प खोजें'),
('search_setting_type_0',	'केवल एक्सेस श्रेणी के आधार पर खोजें'),
('search_setting_type_1',	'पूरी श्रेणी खोजें'),
('search_setting_data_0',	'दुनिया भर में सभी डेटा'),
('search_setting_data_1',	'केवल अपने देश या क्षेत्र में डेटा ढूंढें'),
('search_return',	'खोज के परिणाम'),
('recognition_inp',	'अब बोलो'),
('contact_open_app',	'इस संपर्क को ऐप में खोलें'),
('link_open_app',	'ऐप में खोलें'),
('back_app',	'ऐप पर वापस जाएं'),
('link_open_app_tip',	'इस डेटा को मोबाइल एप्लिकेशन, सॉफ़्टवेयर में तुरंत खोलने या स्थानांतरित करने के लिए यहां क्लिक करें (यदि डेटा के साथ संबंधित एप्लिकेशन के साथ इंस्टॉल किया गया हो)'),
('qr_tip',	'इस लिंक को स्कैन करने के लिए अपने फ़ोन का उपयोग करें!'),
('music_report',	'बग और कॉपीराइट की रिपोर्ट करें'),
('music_report_1',	'दोषपूर्ण गीत (अयोग्य)'),
('music_report_2',	'गीत कॉपीराइट का उल्लंघन करता है कृपया इस सामग्री को हटा दें!'),
('music_report_3',	'इस गीत के साथ एक और समस्या'),
('music_report_3_tip',	'कृपया हमें इस गीत की कमियों के बारे में विस्तार से बताएं'),
('music_report_success',	'इस गीत की समस्या की रिपोर्ट करने के लिए धन्यवाद, हम समस्या को जल्द से जल्द ठीक करने का प्रयास करेंगे'),
('book',	'ई बुक्स'),
('seo_ebook',	'ऑनलाइन पुस्तक पुस्तकालय उपयोगकर्ताओं को मुफ्त किताबें डाउनलोड करने, अच्छी किताबें डाउनलोड करने, मुफ्त किताबें डाउनलोड करने, अच्छी किताबें डाउनलोड करने, ऑनलाइन किताबें पढ़ने की अनुमति देता है। हमारे पास फोन और कंप्यूटर के लिए लोकप्रिय ईबुक प्रारूपों में विभिन्न शैलियों की पुस्तकों की एक विस्तृत श्रृंखला है। आसान निगरानी के लिए पाठक इसे ऑनलाइन देख सकते हैं या अपने कंप्यूटर पर डाउनलोड कर सकते हैं'),
('read_now',	'अभी पढ़ें'),
('mobile_application',	'आवेदन'),
('ebook_muc_luc',	'विषयसूची'),
('ebook_display_options',	'पुस्तक प्रदर्शन विकल्प'),
('ebook_download',	'किताबें डाउनलोड करें (EBook.epub)'),
('ebook_font_size',	'फ़ॉन्ट आकार'),
('ebook_font_style',	'लिपि शैली'),
('dark_mode_sun',	'दिन मोड'),
('dark_mode_moon',	'रात्री स्वरुप'),
('ebook_download_link',	'किताब डाउनलोड करने के लिए यहां क्लिक करें'),
