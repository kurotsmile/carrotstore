...
(115,	'bat_chuyen',	'Ноябрьский месяц наступил ваш путь. Сделайте это потрясающим, неважно, плохая погода, потому что ваше настроение не очень хорошее, вы просто должны стоять высоко и быть счастливым.',	0,	1,	'#E3F9FF',	'',	'',	'',	'',	'',	0,	34,	3,	0,	'',	1,	0,	0,	'',	1,	0,	11,	'415',	'',	'',	'',	'0',	'0',	'0',	''),
(116,	'bat_chuyen',	'Ноябрьский месяц наступил ваш путь. Сделайте это потрясающим, неважно, плохая погода, потому что ваше настроение не очень хорошее, вы просто должны стоять высоко и быть счастливым.',	1,	2,	'#FF2489',	'',	'',	'',	'',	'',	0,	22,	15,	0,	'',	0,	0,	0,	'',	1,	0,	11,	'441',	'',	'',	'',	'0',	'0',	'0',	''),
