...
('ebook_muc_luc',	'สารบัญ'),
('ebook_display_options',	'ตัวเลือกการแสดงหนังสือ'),
('ebook_download',	'ดาวน์โหลดหนังสือ (EBook.epub)'),
('ebook_font_size',	'ขนาดตัวอักษร'),
('ebook_font_style',	'รูปแบบตัวอักษร'),
('dark_mode_sun',	'โหมดกลางวัน'),
('dark_mode_moon',	'โหมดกลางคืน'),
('ebook_download_link',	'คลิกที่นี่เพื่อดาวน์โหลดหนังสือ'),
