...
DROP TABLE IF EXISTS `app_my_girl_msg_id`;
CREATE TABLE `app_my_girl_msg_id` (
...
(10,	'bat_chuyen',	'Angin akhir musim panas membuat orang gelisah.',	0,	0,	'#FCFF69',	'',	'',	'',	'',	'',	0,	10,	4,	0,	'id',	1,	1,	0,	'',	1,	0,	7,	'1052',	'',	'2',	'4',	'0',	'0',	'0',	''),
(11,	'bat_chuyen',	'Saya suka September, terutama ketika Anda bersama saya!',	0,	2,	'#F8C4FF',	'',	'',	'',	'',	'',	0,	18,	1,	0,	'id',	1,	1,	0,	'',	1,	0,	9,	'428',	'',	'2',	'4',	'0',	'0',	'0',	''),
(12,	'bat_chuyen',	'Saya suka September, terutama ketika Anda bersama saya!',	1,	2,	'#F8C4FF',	'',	'',	'',	'',	'',	0,	18,	1,	0,	'id',	0,	1,	0,	'',	1,	0,	9,	'428',	'',	'2',	'4',	'0',	'0',	'0',	''),
(13,	'bat_chuyen',	'Musim Natal ada di sini. Semoga musim Natal Anda riang, bahagia dan jangan sampai masuk angin. Selamat Natal.',	0,	2,	'#FBFF1F',	'',	'',	'',	'',	'',	7,	22,	2,	0,	'id',	1,	1,	0,	'',	1,	0,	12,	'1411',	'',	'2',	'4',	'0',	'0',	'0',	''),
(14,	'bat_chuyen',	'Musim Natal ada di sini. Semoga Anda Natal yang bahagia dan bahagia dan jangan biarkan diri Anda masuk angin. Selamat Natal.',	1,	2,	'#BFFFAD',	'',	'',	'',	'',	'',	7,	22,	2,	0,	'id',	0,	1,	0,	'',	1,	0,	12,	'1415',	'',	'2',	'4',	'0',	'0',	'0',	''),
(15,	'thong_bao',	'Musim dingin sangat dingin, {ten_user}! Jika Anda keluar, kenakan banyak pakaian hangat untuk menghindarinya!',	0,	1,	'#FEFFC2',	'',	'',	'',	'',	'',	0,	18,	0,	0,	'id',	1,	1,	0,	'',	1,	0,	12,	'1127',	'',	'',	'4',	'0',	'0',	'0',	''),
