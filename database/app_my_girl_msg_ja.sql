...
(135,	'dam',	'10月には道路で一人でいるのは簡単です。 余分な服を着ることを忘れて孤独を感じる時間があると、それは冷たくなり始めます。',	0,	3,	'#F3FFC4',	'',	'',	'',	'',	'',	5,	8,	4,	0,	'',	1,	1,	0,	'',	1,	0,	10,	'382',	'',	'',	'',	'0',	'0',	'0',	''),
(136,	'dam',	'10月には道路で一人でいるのは簡単です。 余分な服を着ることを忘れて孤独を感じる時間があると、それは冷たくなり始めます。',	1,	3,	'#54FCFF',	'',	'',	'',	'',	'',	5,	8,	17,	0,	'',	0,	1,	0,	'',	1,	0,	10,	'991',	'',	'',	'',	'0',	'0',	'0',	''),
(137,	'bat_chuyen',	'ハロウィーンに多くの楽しみを抱かせる恐ろしい驚きをたくさん祈ります。',	0,	2,	'#E8FFEF',	'',	'',	'',	'',	'',	0,	13,	15,	0,	'',	1,	1,	0,	'',	1,	30,	10,	'895',	'',	'',	'',	'0',	'0',	'0',	''),
(138,	'bat_chuyen',	'ハロウィーンに多くの楽しみを抱かせる恐ろしい驚きをたくさん祈ります。',	1,	2,	'#A6C9E0',	'',	'',	'',	'',	'',	0,	32,	17,	0,	'',	0,	1,	0,	'',	1,	30,	10,	'874',	'',	'',	'',	'0',	'0',	'0',	''),
...
(171,	'dam',	'私は6月の雨がちょうど降ることをよく知っています。',	0,	3,	'#D7FF26',	'',	'',	'',	'',	'',	5,	1,	4,	0,	'ja',	1,	0,	0,	'',	1,	0,	6,	'1051',	'',	'2',	'4',	'0',	'0',	'0',	''),
(172,	'bat_chuyen',	'それは6月の月、葉とバラの月です。、楽しい光景が目に敬意を表し、楽しい香りが鼻に響くとき。',	0,	2,	'#FF6200',	'',	'',	'',	'',	'',	0,	7,	0,	0,	'ja',	1,	0,	0,	'',	1,	0,	6,	'1455',	'',	'2',	'4',	'0',	'0',	'0',	''),
(173,	'bat_chuyen',	'それは6月の月、葉とバラの月です。、楽しい光景が目に敬意を表し、楽しい香りが鼻に響くとき。',	1,	2,	'#0DFF21',	'',	'',	'',	'',	'',	0,	7,	0,	0,	'ja',	0,	0,	0,	'',	1,	0,	6,	'1016',	'',	'2',	'4',	'0',	'0',	'0',	''),
(174,	'dam',	'私は6月の雨がちょうど降ることをよく知っています。',	1,	1,	'#29FFDF',	'',	'',	'',	'',	'',	5,	1,	0,	0,	'ja',	0,	0,	0,	'',	1,	0,	6,	'1594',	'',	'2',	'4',	'0',	'0',	'0',	''),
