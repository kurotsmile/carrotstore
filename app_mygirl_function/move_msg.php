...
<table style="width: 50%;">
    <tr>
        ...
        <td>
                ...
                <select name="lang_to">
                <?php
                $query_list_lang=mysqli_query($link,"SELECT * FROM `app_my_girl_country` WHERE  `active` = '1' AND `key`!='$lang_move' ORDER BY `id`");
