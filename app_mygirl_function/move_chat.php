<?php
    ...
    $chat_text='';
        ...
        $get_data=mysqli_query($link,"SELECT * from `app_my_girl_$lang_move` where `id`='$id_chat_from' LIMIT 1");
        $data_chat_move=mysqli_fetch_array($get_data);
    ...
    if(isset($_GET['lang_to'])){
        ...
        if($data_chat_move['effect']=='2'){
            ...
            if(mysqli_num_rows($check_video)>0){
                ...
                mysqli_free_result($query_copy_video);
