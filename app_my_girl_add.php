            ...
            <?php } else {
                ...
                <tr>
                    ...
                    <td>
                        ...
                        if ($_GET['effect'] == '2') {
                            if ($txt_key_text == '') {
                                $txt_key_text = get_key_lang('key_music', $lang_sel);
                            }
                            ?>
                            <script>
                        ...
                        if ($_GET['effect'] == '36') {
                            $txt_key_text = get_key_lang('key_quote', $lang_sel);
                        }

                        if ($_GET['effect'] == '49') {
                            $txt_key_text = get_key_lang('key_story', $lang_sel);
                        }
                        }else{
                        ?>
                            <script>
...
if ($key != '') {
    ...
    if (mysql_numrows($result_chat_key) > 0) {
        ...
        while ($row_key = mysql_fetch_array($result_chat_key)) {
            echo show_row_chat_prefab($row_key, $lang_sel, '');
        }
        echo '</table>';
        echo '</div>';
    }
    mysql_free_result($result_chat_key);
}
